...
const bnTranslations: Record<string, string> = {
  ...
  "nav.contact": "যোগাযোগ",
  "nav.recentPosts": "সাম্প্রতিক পোস্ট",
  "nav.work": "কাজ",
  "nav.projects": "প্রকল্প",
  "nav.team": "দল",
  "nav.creative": "ক্রিয়েটিভ",
  "nav.blog": "ব্লগ",
  "nav.reviews": "রিভিউ",
  "nav.contactUs": "যোগাযোগ করুন",
  "nav.customerSafety": "গ্রাহক নিরাপত্তা",
  "nav.drop.overview": "সেবার সারসংক্ষেপ",
  "nav.drop.house": "বাসা বদল ও স্থানান্তর",
  "nav.drop.office": "অফিস সরানো",
  "nav.drop.commercial": "বাণিজ্যিক মালামাল",
  "nav.drop.express": "এক্সপ্রেস ডেলিভারি",
  "nav.drop.howItWorks": "কিভাবে কাজ করে",
  "nav.drop.vehicles": "যানবাহন তালিকা",
  "nav.drop.about": "আমাদের সম্পর্কে",
  ...
  "form.whatsapp": "হোয়াটসঅ্যাপে পাঠান",
  "form.mobileStep1Title": "মৌলিক তথ্য",
  "form.mobileStep2Title": "পিকআপ ও সময়সূচি",
  "form.continue": "পরবর্তী",
  "form.back": "পিছনে",
  ...
  "form.validation.phone": "১১ সংখ্যার মোবাইল লিখুন (০১ দিয়ে শুরু হতে হবে; বাংলা বা ইংরেজি সংখ্যা)",
...
const enTranslations: Record<string, string> = {
  ...
  "nav.customerSafety": "Customer Safety",
  "nav.drop.overview": "Service overview",
  "nav.drop.house": "House shifting",
  "nav.drop.office": "Office relocation",
  "nav.drop.commercial": "Commercial cargo",
  "nav.drop.express": "Express delivery",
  "nav.drop.howItWorks": "How it works",
  "nav.drop.vehicles": "Vehicle fleet",
  "nav.drop.about": "About us",
  ...
  "form.whatsapp": "Submit via WhatsApp",
  "form.mobileStep1Title": "Your details",
  "form.mobileStep2Title": "Pickup & schedule",
  ...
  "form.validation.phone": "Enter an 11-digit mobile number starting with 01 (Bengali or English digits)",
